...
<Velocity11 file='Protocol_Data' md5sum='6b2f645b81ff1fa0d936cf8218c93c89' version='2.0' >
			...
			<Process >
				...
				<Task Name='BuiltIn::Configure Labware' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='5' Value='96 Micronic 1.4mL Tube Rack' />
						<Parameter Category='' Name='6' Value='' />
						<Parameter Category='' Name='7' Value='' />
						<Parameter Category='' Name='8' Value='96 Micronic 1.4mL Tube Rack' />
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Source plate builder' />
						...
						<Parameter Category='Static labware configuration' Name='4' Value='96 Costar 3961 PP 2ml assay block' />
						<Parameter Category='Static labware configuration' Name='5' Value='96 Micronic 1.4mL Tube Rack' />
						...
						<Parameter Category='Static labware configuration' Name='8' Value='96 Micronic 1.4mL Tube Rack' />
						<Parameter Category='Static labware configuration' Name='9' Value='96 V11 LT250 Tip Box Filtered' />
					</Parameters>
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Source plate builder' />
					</Parameters>
				</Task>
				<Plate_Parameters >
			...
			<Pipette_Process Name='Source plate builder' >
				<Minimized >0</Minimized>
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='109' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						...
						<Parameter Category='Properties' Name='Mix cycles' Value='30' />
						<Parameter Category='Properties' Name='Dynamic tip extension' Value='0.15' />
						<Parameter Category='Distance From Well Bottom' Name='Aspirate distance' Value='16' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='Properties' Name='Liquid class' Value='RNA Shield' />
						<Parameter Category='Properties' Name='Distance from well bottom' Value='16' />
						<Parameter Category='Properties' Name='Dynamic tip extension' Value='0.15' />
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='0' />
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='None' />
						<Parameter Category='Tip Touch' Name='Tip touch retract distance' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Move To Location' Task_Type='1024' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location' Value='5' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='This material wii be discarded, place waste plate at position 5.' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<Parameters >
						...
						<Parameter Category='Tip Touch' Name='Tip touch retract distance' Value='25' />
						<Parameter Category='Tip Touch' Name='Tip touch horizontal offset' Value='0.3' />
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;96c4ee4960ded9eefee96345e63a00ec&apos; version=&apos;1.0&apos; &gt;
	&lt;WellSelection CanBe16QuadrantPattern=&apos;0&apos; CanBeLinked=&apos;0&apos; CanBeQuadrantPattern=&apos;0&apos; IsLinked=&apos;0&apos; IsQuadrantPattern=&apos;0&apos; OnlyOneSelection=&apos;0&apos; OverwriteHeadMode=&apos;0&apos; QuadrantPattern=&apos;0&apos; StartingQuadrant=&apos;1&apos; &gt;
		&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;3&apos; SubsetType=&apos;1&apos; TipType=&apos;0&apos; /&gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='' />
						<Parameter Category='' Name='Body' Value='Place Micronic tube rack at position 5.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='' Name='Display dialog box' Value='1' />
						<Parameter Category='' Name='Pause process' Value='1' />
						<Parameter Category='' Name='Email' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Place a 1.2mL Nunc RNA source plate at position 5.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='' Name='Display dialog box' Value='1' />
						<Parameter Category='' Name='Pause process' Value='1' />
						<Parameter Category='' Name='Email' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Change Plate' />
						<Parameter Category='' Name='Body' Value='Plate 1.4mL Micronics rack at position 5.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='' Name='Display dialog box' Value='1' />
						<Parameter Category='' Name='Pause process' Value='1' />
						<Parameter Category='' Name='Email' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<Parameters >
						...
						<Parameter Category='Volume' Name='Post-aspirate volume' Value='0' />
						<Parameter Category='Properties' Name='Liquid class' Value='RNA Shield' />
						<Parameter Category='Properties' Name='Distance from well bottom' Value='7' />
						<Parameter Category='Properties' Name='Dynamic tip extension' Value='0' />
						<Parameter Category='Tip Touch' Name='Perform tip touch' Value='0' />
						<Parameter Category='Tip Touch' Name='Which sides to use for tip touch' Value='None' />
						<Parameter Category='Tip Touch' Name='Tip touch retract distance' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Dispense Complete' />
						<Parameter Category='' Name='Body' Value='Cover the source plate with parafilm.' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='' Name='Display dialog box' Value='1' />
						<Parameter Category='' Name='Pause process' Value='1' />
						<Parameter Category='' Name='Email' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Parameters >
					...
					<Parameter Name='4' Value='96 Costar 3961 PP 2ml assay block' />
					<Parameter Name='5' Value='96 Micronic 1.4mL Tube Rack' />
					<Parameter Name='6' Value='&lt;use default&gt;' />
					<Parameter Name='7' Value='&lt;use default&gt;' />
					<Parameter Name='8' Value='96 Micronic 1.4mL Tube Rack' />
					<Parameter Name='9' Value='96 V11 LT250 Tip Box Filtered' />
				</Parameters>
				<Dependencies />
			</Pipette_Process>
		</Main_Processes>
